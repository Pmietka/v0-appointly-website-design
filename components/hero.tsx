  ...
  return (
    <section className="relative pt-32 pb-24 md:pt-44 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 right-0 w-[700px] h-[700px] rounded-full bg-violet-600/[0.06] blur-[130px]" />
        <div className="absolute top-1/3 left-1/2 w-[400px] h-[400px] rounded-full bg-fuchsia-600/[0.04] blur-[100px]" />
        {/* Dot grid overlay */}
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
            <a
              ...
              style={{
                boxShadow:
                  "0 0 40px hsl(267 72% 55% / 0.4), 0 4px 20px hsl(267 72% 55% / 0.2)",
              }}
            >
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-sm p-7 hover:border-violet-500/30 hover:bg-violet-500/[0.04] transition-all duration-300">
            <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-primary/10 border border-primary/20">
              <CalendarCheck className="h-5 w-5 text-primary" />
            </div>
            <span className="text-3xl font-bold font-display bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">
              250+
            </span>
