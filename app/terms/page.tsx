...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Terms of Service | Appointly Solutions",
    description:
      "Review the terms that govern Appointly Solutions appointment booking services.",
...
const sections = [
  {
    ...
    body:
      "Appointly Solutions provides appointment booking services for home service contractors on a pay-for-performance basis. Services may include campaign management, prospect qualification workflows, calendar booking, follow up, scheduling support, and related reporting.",
  },
  {
    title: "Eligibility",
    body:
  ...
  },
  {
    ...
    body:
      "Appointment qualification standards, target areas, and delivery expectations are defined during onboarding and may vary by market. Appointly Solutions will use commercially reasonable efforts to deliver booked appointments that meet agreed criteria, but close rates and job revenue remain dependent on the contractor’s own sales process and operations.",
  },
  {
    title: "Payment Terms",
    body:
      "Clients agree to pay for booked appointments according to the pricing and billing terms established in their service agreement. Late payments, disputes, and credits are handled according to the same agreement and any related written policies.",
  },
  {
        ...
        <section className="relative pt-32 pb-20 md:pt-44 md:pb-28">
          ...
          <div className="mx-auto max-w-4xl px-6">
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground md:text-lg">
              ...
              website and appointment booking services. Last updated {lastUpdated}.
            </p>
          </div>
        </section>
