...
const sections = [
  ...
  },
  {
    ...
    body: [
      "We use collected information to respond to inquiries, deliver appointment generation services, schedule calls, improve our site performance, and understand how visitors interact with our pages.",
      "Appointly Solutions may also use your information to communicate service updates, share relevant follow up information, and support business operations related to appointment delivery.",
    ],
  },
  {
        ...
        <section className="relative pt-32 pb-20 md:pt-44 md:pb-28">
          ...
          <div className="mx-auto max-w-4xl px-6">
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground md:text-lg">
              ...
              and protects information through this website and related appointment
              generation services. Last updated {lastUpdated}.
            </p>
          </div>
        </section>
