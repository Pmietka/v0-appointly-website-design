  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 right-0 w-[900px] h-[900px] rounded-full bg-primary/[0.07] blur-[140px]" />
        <div className="absolute bottom-0 -left-40 w-[700px] h-[700px] rounded-full bg-violet-500/[0.05] blur-[120px]" />
        <div className="absolute top-2/3 right-1/3 w-[500px] h-[500px] rounded-full bg-accent/[0.05] blur-[100px]" />
        {/* Dot grid */}
        <div className="absolute inset-0 dot-grid opacity-30" />
      </div>

      {/* Navbar */}
      <nav className="border-b border-white/[0.06] bg-background/60 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl flex items-center justify-between px-6 py-4">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-5 py-2.5 text-sm font-semibold text-foreground hover:bg-white/[0.08] transition-all backdrop-blur-sm"
          >
            Book A Call
      ...
      <section className="pt-20 pb-16 md:pt-28 md:pb-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2.5 rounded-full border border-accent/25 bg-accent/[0.08] px-5 py-2 mb-8">
          ...
          <p className="mt-6 text-lg md:text-xl leading-relaxed text-muted-foreground max-w-2xl mx-auto">
            ...
            where you only pay when a real lead hits your phone.
          </p>

          <p className="mt-3 text-base text-muted-foreground/70 max-w-xl mx-auto">
            Watch the short video below so you show up to our call ready to hit
            the ground running.
          </p>
        </div>
      </section>
      ...
      <section className="pb-16 md:pb-20">
        <div className="mx-auto max-w-3xl px-6">
          <div className="relative rounded-3xl overflow-hidden border border-white/[0.08] bg-white/[0.03] aspect-video flex items-center justify-center backdrop-blur-sm">
            {/* Gradient border glow */}
            <div
              className="absolute inset-0 rounded-3xl pointer-events-none"
              style={{
                boxShadow:
                  "inset 0 0 60px hsl(199 89% 48% / 0.05), 0 0 60px hsl(199 89% 48% / 0.1)",
              }}
            />
            ...
            <div className="text-center relative z-10 px-8">
              ...
              <div
                ...
                style={{ boxShadow: "0 0 40px hsl(199 89% 48% / 0.2)" }}
              >
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {callPrep.map((section) => (
              <div
                key={section.title}
                className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-6 hover:border-primary/20 hover:bg-primary/[0.02] transition-all duration-300"
              >
          ...
          <div className="mt-16 text-center">
            ...
            <a
              ...
              style={{
                boxShadow:
                  "0 0 40px hsl(199 89% 48% / 0.3), 0 4px 20px hsl(199 89% 48% / 0.15)",
              }}
            >
      ...
      <footer className="border-t border-white/[0.06] py-8">
        <div className="mx-auto max-w-6xl px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-xs font-bold font-display tracking-widest text-foreground uppercase">
              Appointly
            </span>
          </div>
