...
const faqItems = [
  {
    question: "Can Meta ads produce enough floor coating leads in a small market?",
    answer:
      "Yes. Meta reaches nearly every homeowner in a county, and small markets usually have far less advertiser competition, so cost per lead is often lower than in a big metro. The tradeoff is volume, which is why we size campaigns to your crew.",
  },
  {
    question: "How small is too small?",
    answer:
      "We look at the number of owner-occupied homes with garages inside your drive radius. Most areas with 30,000 or more households can support 10 to 20 booked estimates a month for a single coating contractor.",
  },
  {
    question: "Why does exclusivity matter more in a small market?",
    answer:
      "Because the pool of homeowners is smaller. If two coating contractors advertise to the same 40,000 households, both pay more per estimate and the homeowners hear the same pitch twice. One contractor per market protects your cost and your reputation.",
  },
  {
    question: "Do you book estimates outside major metros in Canada?",
    answer:
      "Yes. We work with contractors across the US and Canada, including regional markets well outside the big cities.",
  },
];

export const metadata: Metadata = {
  title: "Floor Coating Leads for Small Markets | Appointly",
  description:
    "Exclusive floor coating estimates booked for contractors in smaller metros and regional service areas, using Meta ads and instant speed to lead.",
  keywords: [
  ...
  alternates: {
    canonical: "https://getappointly.co/floor-coating-leads-small-markets",
  },
  openGraph: {
    title: "Floor Coating Leads for Small Markets | Appointly",
    description:
      "Explore how Appointly books floor coating estimates for contractors serving smaller metros and regional service areas.",
    url: "https://getappointly.co/floor-coating-leads-small-markets",
      ...
      <main className="overflow-hidden">
        <section className="relative pt-32 pb-20 md:pt-44 md:pb-28">
          ...
          <div className="mx-auto max-w-6xl px-6">
            <Breadcrumbs items={[{ name: "Small Markets", href: "/floor-coating-leads-small-markets" }]} className="mb-8" />
            <div className="max-w-3xl">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                ...
                <Link
                  href="/exclusive-floor-coating-leads"
          ...
          <div className="mx-auto grid max-w-6xl gap-6 px-6 lg:grid-cols-[1.1fr_0.9fr]">
            <article className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="mt-4 text-sm leading-7 text-muted-foreground md:text-base">
                ...
                <Link href="/epoxy-flooring-leads" className="text-primary transition-opacity hover:opacity-80">
