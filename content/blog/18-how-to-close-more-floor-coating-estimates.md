...
That's the **Appointly Model**. You pay a retainer that covers our labor running the system, plus a [per-appointment fee](/pricing) for each [booked estimate](/floor-coating-leads) that lands on your calendar. We run the [Meta ads](/blog/meta-ads-for-floor-coating-contractors), contact every lead instantly before they shop other coaters, and book the estimate into a time that works for you. The homeowner already expects you, so all you have to do is show up, run the process above, do the job, and collect.
