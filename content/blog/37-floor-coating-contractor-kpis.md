---
seo_title: "7 Numbers Every Floor Coating Contractor Should Track"
meta_description: "Seven weekly numbers for floor coating contractors: leads in, speed to lead, answer rate, booking rate, show rate, close rate, and revenue per booked estimate."
date: 2026-09-11
updated: 2026-09-11
author: patrick
cluster: operations
...
# The 7 Numbers Every Floor Coating Contractor Should Track Weekly

**Meta Description:** Seven weekly numbers for floor coating contractors: leads in, speed to lead, answer rate, booking rate, show rate, close rate, and revenue per booked estimate.
...
- Track seven numbers every week on one page: leads in, speed to lead, answer rate, lead to appointment rate, show rate, close rate, and revenue per booked estimate.
- Speed to lead is the number that moves every other number, and the target is a first call within one minute of the form being submitted.
- Between 60 and 70% of leads should become a booked estimate, and a lead called within one minute answers 90% of the time.
- Show rate should be about 95% with a confirmation at booking, a reminder 24 hours out, a reminder one hour out, and a person chasing anyone who goes quiet.
- There is no published close rate benchmark, so record your own every week and expect it to move when the estimator gets coached.
...
The [benchmark](/floor-coating-benchmarks) is 90% when the lead is called within one minute of submitting the form. If your speed to lead is slow, a low answer rate is a symptom. Fix the speed first.
...
The target is 60 to 70%. If you are at 30%, either the leads are wrong, the call is slow, or the caller is talking the homeowner out of it. Our post on [lead to appointment rate](/blog/floor-coating-lead-to-appointment-rate) walks through which of those it usually is.
...
When it is off: check that the reminders are going out and that someone is watching for the homeowner who never confirms. Our post on [floor coating estimate no-shows](/blog/floor-coating-estimate-no-shows) has the exact sequence.
...
| Metric | This week | Target | Action |
|---|---|---|---|
| Leads in | | Enough to feed the crew | |
| Speed to lead (median minutes) | | Under 1 minute | |
| Phone answer rate | | 90% | |
| Lead to appointment rate | | 60 to 70% | |
| Show rate | | 95% with reminders | |
| Close rate | | Your own trailing average, rising | |
| Revenue per booked estimate | | Your own number, rising | |
...
Start with the three numbers that need nothing but a call log: leads in, speed to lead, and answer rate. Once the phone is fast, add the rest and watch which one moves. If you would rather have the front half of the scoreboard handled for you, see how [booked floor coating estimates](/floor-coating-leads) work, with our team calling every lead in about a minute.

For a second set of eyes on your numbers, [book a strategy call](https://client.getappointly.co/strategy-calendar) and bring last week's scoreboard. We will tell you which number to fix first.
